...
for herb_row in herbs_rows:
    row_vals = herb_row.split(',')
    herb_name_scientific = row_vals[0]
    herb_family = row_vals[1].strip().lower()
...
def gen_vertex_herb_attr_list_json(vertex, key, prompt):
    if key not in vertex_herb: vertex_herb[key] = []
    # vertex_herb[key] = []
    if vertex_herb[key] == []:
        herb_name_scientific = vertex_herb['herb_name_scientific']
...
##################################################################################
for vertex_herb in vertices_herbs:
    gen_vertex_herb_attr_list_json(
        vertex = vertex_herb,
        key = 'herb_benefits', 
        prompt = f'''
            Write a list of the 20 most important health benefits names of the plant {herb_name_scientific}.
...
for vertex_herb in vertices_herbs:
    gen_vertex_herb_attr_list_json(
        ...
        key = 'herb_properties', 
        prompt = f'''
            Write a list of the 20 best therapeutic properties names of the plant {herb_name_scientific}.
...
for vertex_herb in vertices_herbs:
    gen_vertex_herb_attr_list_json(
        ...
        prompt = f'''
            Write a list of the 20 most important medicinal constituents names of the plant {herb_name_scientific}.
...
for vertex_herb in vertices_herbs:
    gen_vertex_herb_attr_list_json(
        ...
        key = 'herb_parts', 
        prompt = f'''
            Write a list of the 20 most important parts names of the plant {herb_name_scientific} used for medicinal purposes.
...
for vertex_herb in vertices_herbs:
    gen_vertex_herb_attr_list_json(
        ...
        prompt = f'''
            Write a list of the 20 most common negative health side effects names of the plant {herb_name_scientific}.
...
if 1:
    for vertex in vertices_herbs:
        herb_slug = vertex['herb_slug']
        herbs_slugs = [edge['vertex_1'] for edge in edges_herbs_preparations]
        if herb_slug in herbs_slugs: 
            continue
        herb_name_scientific = vertex['herb_name_scientific']
...
if 1:
    for vertex_herb in vertices_herbs:
        ...
        herbs_slugs = [edge['vertex_1'] for edge in edges_herbs_ailments]
        if herb_slug in herbs_slugs: 
            continue
        herb_name_scientific = vertex_herb['herb_name_scientific']
